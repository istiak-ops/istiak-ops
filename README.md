...
|[Observability Stack - Astronomy Shop](https://github.com/istiak-devsecops/astronomy-shop) | Complete monitoring stack for apps with Prometheus, Grafana dashboards and Alert Manager | Prometheus, Grafana, Alert Manager, Kubernetes, AWS, Helm, ElasticSearch, Jaeger, OTeL |
